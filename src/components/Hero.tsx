...
export default function Hero() {
  ...
  return (
    <>
      <div className="relative container mx-auto px-4 min-h-screen flex flex-col justify-center">
       
        <div className="relative flex flex-col md:grid md:grid-cols-2 gap-6 p-4 md:p-6 bg-white/80 backdrop-blur-sm rounded-lg">
          {/* Headline Section */}
          <div id="headline" className="flex flex-col justify-center p-2 md:p-6">
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-3 sm:space-y-0 sm:space-x-4">
              ...
              <Button
                className="shadow-2xl h-10 rounded-full bg-white border border-gray-300"
